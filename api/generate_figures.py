...
url_ffhq        = 'https://sagemaker-hackaton.s3.amazonaws.com/karras2019stylegan-ffhq-1024x1024.pkl' # karras2019stylegan-ffhq-1024x1024.pkl
...
def draw_style_mixing_figure(png, Gs, w, h, src_seeds, dst_seeds, style_ranges):
    ...
    dst_dlatents = np.stack([np.load('latent_representations/alexis_sanchez_01.npy'),
                             np.load('latent_representations/alexis_sanchez_01.npy'),
                             np.load('latent_representations/alexis_sanchez_01.npy'),
                             np.load('latent_representations/alexis_sanchez_01.npy'),
                             np.load('latent_representations/alexis_sanchez_01.npy'),
                             np.load('latent_representations/alexis_sanchez_01.npy')])
...
def main():
    ...
    test_single_image(os.path.join(config.result_dir, 'single_image.png'), load_Gs(url_ffhq), w=1024, h=1024, src_seeds=[639,701,687,615,2268], dst_seeds=[888,829,1898,1733,1614,845], style_ranges=[range(0,4)]*3+[range(4,8)]*2+[range(8,18)])
