...
def main():
    ...
    test_single_image('single_image.png', load_Gs(url_ffhq), w=1024, h=1024, src_seeds=[687,687,687,687,687], dst_seeds=[888,829,1898,1733,1614,845], style_ranges=[range(0,4)]*3+[range(0,4)]*2+[range(0,4)])
